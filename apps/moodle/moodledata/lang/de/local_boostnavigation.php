...
/**
 * Strings for component 'local_boostnavigation', language 'de', branch 'MOODLE_38_STABLE'
 *
...
$string['setting_customnodesusagepleasenotecss'] = 'Aufgrund der Art und Weise wie die Navigation in Boost in Moodle gebaut ist, werden alle Knoten gleichartig angezeigt. Nicht möglich ist es, eigene CSS Klassen, IDs für HTML-Elemente oder ein Zielattribut zum Öffnen eines Links in einem neuen Fenster anzugeben.';
...
$string['setting_insertactivitiescoursenodeexplanation'] = 'Dieser Knoten enthält wiederum Knotent, die auf die Überseitsseiten der Aktivitäten verlinken. Dieser Knoten bringt im Prinzip die Funktionalität des "Aktivitäten" Blocks in die Boost Navigation.';
