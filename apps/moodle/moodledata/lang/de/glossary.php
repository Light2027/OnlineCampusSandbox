...
/**
 * Strings for component 'glossary', language 'de', branch 'MOODLE_39_STABLE'
 *
 * @package   glossary
...
Ein Lehrer kann zulassen, dass Dateien an Glossareinträge angehängt werden. Angehängte Bilder werden im Eintrag angezeigt. Einträge können alphabetisch oder nach Kategorie, Datum oder Autor dargestellt oder durchsucht werden. Einträge können standardmäßig genehmigt werden oder müssen von einer/m Trainer/in genehmigt werden, bevor sie von allen angezeigt werden können.
