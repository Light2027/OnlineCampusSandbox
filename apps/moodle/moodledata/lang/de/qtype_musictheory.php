...
/**
 * Strings for component 'qtype_musictheory', language 'de', branch 'MOODLE_39_STABLE'
 *
...
$string['note_write_questionastext_help'] = '<p>Gib folgende Note OHNE Leerzeichen ein. Verwende dafür folgende Schreibweise: </p><p>[Großbuchstabe][Vorzeichen
  ("n" = ohne Vorzeichen, "#" = Kreuz, "b" = b-Vorzeichen, "x" = Doppelkreuz, "bb" = Doppel-b-Vorzeichen)] [Oktavraum (eine Zahl zwischen 1 und 6, nach dem Vorbild der der scientific pitch notation)]</p>
 <p>Beispiel: </p><ul><li><b>Gn5</b></li><li><b>A#4</b></li><li><b>Ebb3</b></li></ul>';
...
$string['validation_scale_invalidtonic'] = 'Ungültige Tonika für die angegebene Tonleiter';
