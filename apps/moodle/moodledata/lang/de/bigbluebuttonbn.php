...
/**
 * Strings for component 'bigbluebuttonbn', language 'de', branch 'MOODLE_39_STABLE'
 *
...
$string['config_importrecordings'] = 'Konfiguration der Aufzeichnungsimportfunktion';
...
$string['config_meetingevents_enabled_description'] = 'Das Registrieren von Meeting-Events ist aktiviert. Diese Option ist experimentell und funktioniert nur, wenn der BigBlueButton-Server post_events Scripts unterstützt.';
$string['config_muteonstart'] = 'Konfiguration für die Funktion "Mute on Start"';
$string['config_muteonstart_default'] = '"Mute on Start" standardmäßig aktiviert';
...
$string['config_muteonstart_description'] = 'Diese Einstellungen aktivieren oder deaktivieren Optionen in der Benutzeroberfläche und definieren auch Standardwerte für diese Optionen.';
$string['config_muteonstart_editable'] = '"Mute on Start" kann geändert werden';
$string['config_muteonstart_editable_description'] = 'Diese Option legt fest, dass die standardmäßige Einstellungen "Mute on Start" jederzeit geändert werden kann.';
...
$string['config_recordingready_enabled'] = 'Hinweis, wenn die Aufzeichnung fertig ist.';
...
$string['config_recordings'] = 'Einstellungen für die Funktion "Aufzeichnungen anzeigen".';
...
$string['index_error_noinstances'] = 'Es gibt keine Instanzen von bigbluebuttonbn';
...
$string['mod_form_field_muteonstart'] = 'Beim Start stummschalten';
...
$string['view_mobile_message_groups_not_supported'] = 'Diese Instanz ermöglicht die Arbeit mit Gruppen, aber die mobile Anwendung bietet dafür keine Unterstützung. Bitte öffnen Sie im Desktop, wenn Sie die Gruppenunterstützung nutzen wollen.';
