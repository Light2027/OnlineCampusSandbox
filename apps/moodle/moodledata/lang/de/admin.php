...
/**
 * Strings for component 'admin', language 'de', branch 'MOODLE_39_STABLE'
 *
 * @package   admin
...
$string['cliupgradepending'] = 'Ein Upgrade wird derzeit durchgeführt.';
...
$string['userfeedbackencouragement'] = '<p>Moodle 3.9 enthält eine neue Funktion, die den Nutzer/innen die Möglichkeit gibt, dem Moodle HQ über eine externe Umfrage-Website, die vom Moodle HQ gehostet wird, Feedback zur Moodle-Software zu geben. Es werden keine personenidentifizierenden Informationen an die Umfrageseite weitergeleitet.</p>
<p>Moodle HQ bemüht sich um eine offene und transparente Datenerhebungspraxis. Deswegen möchten wir sicherstellen, dass Sie sich dieser Funktionalität bewusst sind und sie unter Kontrolle haben.</p>
<p>Ein Feedback von Nutzer/innen würde dem Moodle HQ sehr helfen, die Moodle-Software zu verbessern. Um diese Funktion zu aktivieren, gehen Sie bitte zu <a href="{$a}">Feedback-Einstellungen</a>.</p>';
