...
/**
 * Strings for component 'plagiarism_turnitinsim', language 'de', branch 'MOODLE_39_STABLE'
 *
...
$string['line'] = 'Zeile';
$string['loadingcv'] = 'Turnitin Cloud Viewer wird geladen';
...
$string['privacy:metadata:plagiarism_turnitinsim_client:firstname'] = 'Der Vorname des Benutzers wird an Turnitin bei einem Cloud Viewer-Start gesendet, sodass der Benutzer identifiziert werden kann.';
$string['privacy:metadata:plagiarism_turnitinsim_client:lastname'] = 'Der Nachname des Benutzers wird an Turnitin bei einem Cloud Viewer-Start gesendet, sodass der Benutzer identifiziert werden kann.';
...
$string['taskoutputfailedcvlaunchurl'] = 'Fehler beim Abfragen einer Cloud Viewer-Start-URL von der Turnitin-API für Übermittlungs-ID: {$a}';
...
$string['turnitinfeatures::viewoptions'] = 'Cloud Viewer-Optionen:';
