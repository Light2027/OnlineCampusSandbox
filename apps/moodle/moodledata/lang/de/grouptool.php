...
/**
 * Strings for component 'grouptool', language 'de', branch 'MOODLE_38_STABLE'
 *
 * @package   grouptool
...
$string['already_queued'] = '<strong>{$a->username}</strong> ist bereits in der Warteschlange von Gruppe <strong>{$a->groupname}</strong>!';
...
$string['import_conflict_user_queued'] = 'Teilnehmer/in <strong>{$a->fullname}</strong> ist bereits in der Warteschlange der Gruppe <strong>{$a->groupname}</strong>!';
...
$string['multiple_desc'] = 'Mehr-/ Vielfaches Austragen';
...
$string['notification:group_recreated'] = 'Die Gruppe <strong>{$a->groupname}</strong> wurde durch die Gruppenverwaltung <strong><a href="{$a->grouptoolurl}" title="{$a->grouptoolname}">{$a->grouptoolname}</a></strong> wiederhergestellt, da diese Gruppenverwaltung eingestellt wurde, gelöschte Gruppen wiederherzustellen.';
$string['notification:registrations_recreated'] = 'Die Gruppenmitglieder der Gruppe <strong>{$a->groupname}</strong>\' wurden wiederhergestellt, da die Gruppenverwaltung <strong><a href="{$a->grouptoolurl}" title="{$a->grouptoolname}">{$a->grouptoolname}</a></strong> eingestellt wurde, gelöschte Gruppen wiederherszustellen. Die Gruppe selbst wurde von einer anderen Gruppenverwaltungsinstanz wiederhergestellt.';
$string['not_in_queue_or_registered'] = '<strong>{$a->username}</strong> ist weder in der Gruppe <strong>{$a->groupname}</strong> angemeldet noch in deren Warteschlange gereiht.';
...
$string['queued_in_group_info'] = '<strong>{$a->username}</strong> in Warteschlange von <strong>{$a->groupname}</strong>';
$string['queued_on_rank'] = 'In Warteliste auf Platz #{$a}';
$string['queueing_is'] = 'Wartelisten sind';
$string['queue_in_group'] = 'Trage <strong>{$a->username}</strong> in Warteschlange der Gruppe <strong>{$a->groupname}</strong> ein?';
$string['queue_in_group_success'] = '<strong>{$a->username}</strong> erfolgreich in Warteschlange der Gruppe <strong>{$a->groupname}</strong> eingetragen!';
...
$string['queue_you_in_group'] = 'Wollen Sie in die Warteschlange der Gruppe <strong>{$a->groupname}</strong> eingetragen werden?';
$string['queue_you_in_group_success'] = 'Sie wurden erfolgreich in die Warteschlange der Gruppe <strong>{$a->groupname}</strong> eingetragen!';
$string['rank'] = 'Rang';
...
$string['too_many_queue_places'] = 'Kann <strong>{$a->username}</strong> nicht in Warteschlange der Gruppe <strong>{$a->groupname}</strong> eintragen, weil <strong>{$a->username}</strong> bereits in zu vielen Warteschlangen eingetragen ist!';
...
$string['unqueue_from_group'] = 'Wirklich mit Austragen von <strong>{$a->username}</strong> aus Warteschlange der Gruppe <strong>{$a->groupname}</strong> fortfahren?';
$string['unqueue_from_group_success'] = 'Austragen von <strong>{$a->username}</strong> aus Warteschlange der Gruppe <strong>{$a->groupname}</strong> erfolgreich!';
$string['unqueue_you_from_group'] = 'Wollen Sie sich wirklich aus der Warteschlange der Gruppe <strong>{$a->groupname}</strong> austragen?';
$string['unqueue_you_from_group_success'] = 'Sie wurden erfolgreich aus der Warteschlange der Gruppe <strong>{$a->groupname}</strong> ausgetragen!';
$string['unreg'] = 'Austragen';
...
$string['unregister_desc'] = 'Mehrere/ viele Teilnehmer/innen austragen';
...
$string['use_queue_help'] = 'Teilnehmer/innen können sich selbst für bereits volle Gruppen in einer Warteschlange registrieren. Diese Einstellung kann nur verwendet werden, wenn die Selbstanmeldung zugelassen und eine Gruppengröße gesetzt wurde.';
...
$string['user_moved'] = '<strong>{$a->user}</strong> wurde von der Warteschlange von Gruppe <strong>{$a->from_group}</strong> zur Gruppe <strong>{$a->to_group}</strong> verschoben!';
$string['user_move_prev'] = '<strong>{$a->user}</strong> wird von der Warteschlange von Gruppe <strong>{$a->from_group}</strong> zur Gruppe <strong>{$a->to_group}</strong> verschoben!';
...
$string['you_are_already_queued'] = 'Sie sind bereits in der Warteschlange von Gruppe <strong>{$a->groupname}</strong>!';
$string['you_are_already_registered'] = 'Sie sind bereits in der Gruppe <strong>{$a->groupname}</strong> registriert!';
$string['you_are_not_in_queue_or_registered'] = 'Sie sind weder in der Gruppe <strong>{$a->groupname}</strong> angemeldet noch in deren Warteschlange gereiht.';
...
$string['you_have_too_many_queue_places'] = 'Kann Sie nicht in Warteschlange der Gruppe <strong>{$a->groupname}</strong> eintragen, weil Sie bereits in zu vielen Warteschlangen eingetragen sind!';
